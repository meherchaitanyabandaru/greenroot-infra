-- =============================================================================
-- GreenRoot — Authoritative Schema Dump
-- =============================================================================
-- Generated from the live database. This is the single source of truth.
-- Do NOT edit manually — re-generate with:
--
--   pg_dump 'postgres:///greenroot?host=/tmp' \
--     --schema-only --no-owner --no-acl --schema=public \
--     > greenroot-infra/db/postgresql/greenroot_schema.sql
--
-- To set up a fresh database:
--   createdb greenroot
--   psql 'postgres:///greenroot?host=/tmp' -f greenroot_schema.sql
--   psql 'postgres:///greenroot?host=/tmp' -f greenroot-seed.sql
-- =============================================================================

-- PostgreSQL database dump

\restrict v3Ef6zBLxT4VZAh49oDSPAHdWWAbDxIbBbi5TnPZGmlb0J0WnnAettTkQYehnWV
...
\unrestrict v3Ef6zBLxT4VZAh49oDSPAHdWWAbDxIbBbi5TnPZGmlb0J0WnnAettTkQYehnWV
